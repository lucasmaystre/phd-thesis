...
Figure~\ref{in:fig:crimedata} presents a reproduction\footnote{%
...
\begin{figure}[ht]
\centering
\includegraphics[width=\linewidth]{in-crimedata}
\caption{
...
Figure~\ref{in:fig:pwmodels} illustrates the probabilities~\eqref{in:eq:thu5} and~\eqref{in:eq:bt} as a function of $\theta_i - \theta_j$.

\begin{figure}[ht]
\centering
\includegraphics{in-pwmodels}
\caption{
