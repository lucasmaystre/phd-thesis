...
In Chapter~\ref{ch:robustsort}, we shift our attention to the task of ``intelligently'' sampling pairwise comparison outcomes, based on the observed outcomes of previous comparisons.
