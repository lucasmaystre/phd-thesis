...
In the case where $\bm{Q}$ is dense, the running time of a typical implementation is $O(N^3)$, but highly optimized parallel implementations such as that provided by LAPACK \citep{anderson1999lapack} are commonly available.
