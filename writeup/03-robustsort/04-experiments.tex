...
We now investigate three datasets and measure the displacement of rankings estimated from adaptively-chosen samples, as a function of the budget $c$.
...
\begin{figure}[t]
\centering
\includegraphics[width=0.67\linewidth]{rs-baselines}
\caption{
...
\begin{figure*}[t]
\centering
\includegraphics[width=\linewidth]{rs-datasets}
\caption{
...
Results are shown in Figure~\ref{rs:fig:datasets} (left).
...
Figure~\ref{rs:fig:datasets} (right) compares the displacement of random sampling to that of the two sorting-based sampling strategies for increasing $c$.
